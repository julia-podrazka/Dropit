...
#LOAD DATA LOCAL INFILE 'exxercise_dataset.csv' INTO TABLE CaloriesBurnedDuringExercise_caloriesburnedduringexercise FIELDS TERMINATED BY ';' LINES TERMINATED BY '\n' IGNORE 2 ROWS (exercise, lb130, lb150, lb180, lb205, calories_per_kg);
